...
import { Client } from '@mycelium-now/core';
...
var MyceliumContext = /*#__PURE__*/createContext(null);
/**
...
function MyceliumProvider(_ref) {
  ...
  return React.createElement(MyceliumContext.Provider, {
    value: state
  }, children);
}
...
function useMyceliumClient() {
  var ctx = useContext(MyceliumContext);
...
function useChannel(channelName) {
  !channelName ? process.env.NODE_ENV !== "production" ? invariant(false, 'Must supply channelName to useChannel') : invariant(false) : void 0;
...
function useOnEvent(channel, event, listener) {
  ...
  !event ? process.env.NODE_ENV !== "production" ? invariant(false, 'Must supply event to useOnEvent') : invariant(false) : void 0;
  !listener ? process.env.NODE_ENV !== "production" ? invariant(false, 'Must supply listener to useOnEvent') : invariant(false) : void 0;
  useEffect(function () {
    if (!channel) {
      return;
    }
...
function useOnAnyEvent(channel, listener) {
  // error when required arguments aren't passed.
  !listener ? process.env.NODE_ENV !== "production" ? invariant(false, 'Must supply listener to useOnAnyEvent') : invariant(false) : void 0;
  useEffect(function () {
    if (!channel) {
      return;
    }
...
function useOnceEvent(channel, event, listener) {
  // error when required arguments aren't passed.
  !event ? process.env.NODE_ENV !== "production" ? invariant(false, 'Must supply event to useOnceEvent') : invariant(false) : void 0;
  !listener ? process.env.NODE_ENV !== "production" ? invariant(false, 'Must supply listener to useOnceEvent') : invariant(false) : void 0;
  useEffect(function () {
    if (!channel) {
      return;
    }
...
function usePrependAnyEvent(channel, listener) {
  // error when required arguments aren't passed.
  !listener ? process.env.NODE_ENV !== "production" ? invariant(false, 'Must supply listener to usePrependAnyEvent') : invariant(false) : void 0;
  useEffect(function () {
    if (!channel) {
      return;
    }
...
export { MyceliumProvider, useChannel, useMyceliumClient, useOnAnyEvent, useOnEvent, useOnceEvent, usePrependAnyEvent, usePublishEvent, useSubscribe };
